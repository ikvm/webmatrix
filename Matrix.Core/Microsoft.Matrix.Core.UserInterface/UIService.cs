namespace Microsoft.Matrix.Core.UserInterface
{
    ...
    internal sealed class UIService : IMxUIService, IUIService, IDisposable
    {
        ...
        public void ReportError(Exception exception, string caption, bool isWarning)
        {
            string message;
            if (exception == null)
            {
        ...
        public void ReportError(string error, string caption, bool isWarning)
        {
        ...
        {
            this.ShowMessageInternal(text, caption, MessageBoxIcon.Asterisk, MessageBoxButtons.OK, MessageBoxDefaultButton.Button1);
        }

        public DialogResult ShowMessage(string text, string caption, MessageBoxIcon icon, MessageBoxButtons buttons)
        {
            return this.ShowMessageInternal(text, caption, icon, buttons, MessageBoxDefaultButton.Button1);
        }

        public DialogResult ShowMessage(string text, string caption, MessageBoxIcon icon, MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            return this.ShowMessageInternal(text, caption, icon, buttons, defaultButton);
        }

        private DialogResult ShowMessageInternal(string message, string caption, MessageBoxIcon icon, MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            DialogResult cancel = DialogResult.Cancel;
            this.EnableModelessUI(false);
            try
