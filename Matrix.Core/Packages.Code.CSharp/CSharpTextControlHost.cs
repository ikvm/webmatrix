namespace Microsoft.Matrix.Packages.Code.CSharp
{
    ...
    public class CSharpTextControlHost : ITextControlHost, IDisposable
    {
        private TextControl _control;
        private ArrayList _handlerList;

        public CSharpTextControlHost(TextControl control)
        {
        ...
        public void OnTextViewCreated(TextView view)
        {
            ...
            this.HandlerList.Add(new CSharpTextViewCommandHandler(view));
        }
