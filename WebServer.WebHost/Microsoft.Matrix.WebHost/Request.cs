namespace Microsoft.Matrix.WebHost
{
    ...
    internal sealed class Request : SimpleWorkerRequest
    {
        ...
        {
            if (((this._path != null) && (this._path.IndexOfAny(badPathChars) < 0)) && (this._path.IndexOf("..") < 0))
            {
                return false;
            }
            return true;
        ...
        public override string MapPath(string path)
        {
            ...
            if (((path == null) || (path.Length == 0)) || (path.Equals("/") || this._host.IsVirtualPathAppPath(path)))
            {
        ...
        public void Process()
        {
            ...
            else if (((this._headerBytes == null) || (this._endHeadersOffset < 0)) || ((this._headerByteStrings == null) || (this._headerByteStrings.Count == 0)))
            {
            ...
            else
            {
                ...
                else if (!this._host.IsVirtualPathInApp(this._url))
                {
        ...
        private bool ProcessDirectoryListingRequest()
        {
            ...
            foreach (string str4 in defaultFileNames)
            {
